namespace Language_CN
{
    #region 公共事件提示标题
    public class WindowEventTitleContent
    {
        private string ttitleWarning = "警告";
        private string titleError = "错误";
        private string titleInfomation = "提示";
    ...
    public class LoginWindowEventContents
    {
        ...
        private string nullUserName = "请输入用户名！";
    ...
    public class MainMenu
    {
        ...
        private string mViewStw = "系统日志窗口";
    ...
    {
        ScannerInfoSearch scannerInfoSearchContent;
        ScannerInfoDataGrid scannerInfoGridContent;
    ...
    {
        BlcakListInfoSearch BlackListInfoSearchContent;
        BlcakListInfoDataGrid BlackListInfoGridContent;
    ...
    public class Device_managerWindow
    {
        ...
        private string deviceUpdateCaption = "小区信息更新";
        private string morePLMNSListCaption = "PLMN";
        private string perierFreqListCaption = "频点";
        private string otherPlmnSettingCaption = "等效PLMN更新";
        ...
        private string synchroSourceCaption = "同步优先级";
        ...
        #region GSMV2
        private string gSMV2WorkModel = "工作模式";
        private string gSMV2Attenuation = "衰减";
        private string gSMV2PhysicsCellId = "物理小区ID";
        private string gSMV2AreaCode = "区域码";
        private string gSMV2CellID = "小区ID";
        private string gSMV2CellEarfcn = "小区频点";
        private string gSMV2SendPower = "发送功率";
        private string gSMV2BlackEarfcn = "黑名单频点";

        private string wCDMAFreqUpdateCaption = "更新";
        private string wCDMANTPUpdateCaption = "更新";
        private string wCDMAUpdateTimeCaption = "更新";

        public string GSMV2WorkModel
        {
            get
            {
                return gSMV2WorkModel;
            }


            set
            {
                gSMV2WorkModel = value;
            }
        }
        public string GSMV2Attenuation
        {
            get
            {
                return gSMV2Attenuation;
            }

            set
            {
                gSMV2Attenuation = value;
            }
        }
        public string GSMV2PhysicsCellId
        {
            get
            {
                return gSMV2PhysicsCellId;
            }

            set
            {
                gSMV2PhysicsCellId = value;
            }
        }
        public string GSMV2AreaCode
        {
            get
            {
                return gSMV2AreaCode;
            }
        ...
        public string GSMV2CellEarfcn
        {
            get
            {
                return gSMV2CellEarfcn;
            }

            set
            {
                gSMV2CellEarfcn = value;
            }
        }
        public string GSMV2SendPower
        {
            get
            {
                return gSMV2SendPower;
            }

            set
            {
                gSMV2SendPower = value;
            }
        }
        public string GSMV2BlackEarfcn
        {
            get
            {
                return gSMV2BlackEarfcn;
            }

            set
            {
                gSMV2BlackEarfcn = value;
            }
        }
        #endregion
        ...
        #region 非XML设置
        private string noXMLSet = "非XML设置";
        private string enable = "使能开关";
        private string commEnable = "通讯配置通道";
        private string messageFormat = "上传方式";
        private string commIp = "通讯配置通道IP";
        private string commPort = "端口";
        private string type = "通信方式";
        private string period = "上报周期";
        private string encryptType = "加密类型";
        private string cacheMax = "最大缓存数";
        private string dataFormat = "上报数据格式";
        private string nameFormat = "上报文件名格式";
        private string urlorIP = "URL";
        private string addInfo = "附加信息";

        private string selectUpLoad = "查询";
        private string setUpLoad = "设置";

        public string NoXMLSet
        {
            get
            {
                return noXMLSet;
    ...
    public class ScannerInfos
    {
        ...
        private string aPAreaInfoHead = "邻区信息";
    ...
    public class SpeciallistManageClass
    {
        ...
        private string settingCaption = "重定向设置";
        ...
        private string rejectMethodCaption = "用户拒绝策略";
        private string frequencyCaption = "频点";
    ...
    public class RedirectSetClass
    {
        ...
        private string optimizationCaption = "频点";
        private string priorityCaption = "优选";
        private string rejectMethodCaption = "用户拒绝策略";
        private string additionalFreqCaption = "附加频点";
        private string btnSelect = "查询";
        private string btnOK = "设置";
    ...
    public class QueryHistoricalData
    {
        ...
        private string QHD_iMEI = "IMEI";
        private string QHD_startTime = "开始时间";
        private string QHD_stopTime = "结束时间";
        private string QHD_deviceManager = "类型";
        private string cbDeviceListAll = "全部";
        private string cbDeviceListDevice = "设备";
        private string cbDeviceListDomain = "域";
        ...
        private string QHD_des = "别名";

        private string device = "设备";
        private string domain = "域";
        private string bwFlag = "名单";
        private string cbBwFlagAll = "所有";
        private string cbBwFlagBlack = "白名单";
        private string cbBwFlagWhite = "黑名单";
        private string cbBwFlagOther = "普通用户";
        ...
        public string CbDeviceListAll
        {
            get { return cbDeviceListAll; }
            set { cbDeviceListAll = value; }
        }
        public string CbDeviceListDevice
        {
            get { return cbDeviceListDevice; }
            set { cbDeviceListDevice = value; }
        }
        public string CbDeviceListDomain
        {
            get { return cbDeviceListDomain; }
            set { cbDeviceListDomain = value; }
        }
        ...
        public string CbBwFlagAll
        {
            get { return cbBwFlagAll; }
            set { cbBwFlagAll = value; }
        }
        public string CbBwFlagBlack
        {
            get { return cbBwFlagBlack; }
            set { cbBwFlagBlack = value; }
        }
        public string CbBwFlagWhite
        {
            get { return cbBwFlagWhite; }
            set { cbBwFlagWhite = value; }
        }
        public string CbBwFlagOther
        {
            get { return cbBwFlagOther; }
            set { cbBwFlagOther = value; }
        }
    }
    #endregion
    ...
    {
        private string accountManagement = "账号管理";

        private string user_accountNumber = "账号设置";
        private string user_userName = "用户名";
        private string user_userGroup = "用户组";
        private string user_password = "密码";
        private string user_alias = "别名";
        private string user_manufacturer = "生成人";
        private string user_addUser = "增加";
        private string user_updateUser = "更新";
        private string user_deleteUser = "删除";

        private string group_userGroup = "用户组设置";
        ...
        {
            get { return user_accountNumber; }
            set { user_accountNumber = value; }
        }
        ...
        public string user_UserGroup
        {
            get { return user_userGroup; }
            set { user_userGroup = value; }
        }
        ...
        {
            get { return user_alias; }
            set { user_alias = value; }
        }
        public string user_Manufacturer
        {
            get { return user_manufacturer; }
            set { user_manufacturer = value; }
        }
        public string user_AddUser
        {
            get { return user_addUser; }
            set { user_addUser = value; }
        }
        public string user_UpdateUser
        {
            get { return user_updateUser; }
            set { user_updateUser = value; }
        }
        public string user_DeleteUser
        {
            get { return user_deleteUser; }
            set { user_deleteUser = value; }
        }
        public string group_UserGroup
        {
            get { return group_userGroup; }
            set { group_userGroup = value; }
        }
    }
    #endregion
    ...
    public class SettingSym
    {
        ...
        private string localLocation = "本地设置";
    ...
    public class AddUserGroup
    {
        ...
        private string loreStartTime = "开始日期";
        private string loreEndTime = "结束日期";
        ...
        public string LoreStartTime
        {
            get { return loreStartTime; }
            set { loreStartTime = value; }
        }
        public string LoreEndTime
        {
            get { return loreEndTime; }
            set { loreEndTime = value; }
        }
    ...
    public class LTEDeviceDetail
    {
        ...
        private string freqPCICaption_CDMA = "BSID/LAC";
        private string freqPCICaption_GSMV2 = "频点/LAC";
        ...
        public string FreqPCICaption_CDMA
        {
            get
            {
                return freqPCICaption_CDMA;
            }

            set
            {
                freqPCICaption_CDMA = value;
            }
        }
        public string FreqPCICaption_GSMV2
        {
            get
            {
                return freqPCICaption_GSMV2;
            }

            set
            {
                freqPCICaption_GSMV2 = value;
            }
        }
    ...
    {
        private string updateUserInfoTitle = "修改用户密码";
        private string updateUserName = "用户名";
        private string updateNewPassword = "输入新密码";
        private string updateOldPassword = "输入旧密码";
        private string updateOK = "确定";
        private string updateCancel = "取消";
        public string UpdateUserInfoTitle { get { return updateUserInfoTitle; } set { updateUserInfoTitle = value; } }
        public string UpdateUserName { get { return updateUserName; } set { updateUserName = value; } }
        public string UpdateNewPassword { get { return updateNewPassword; } set { updateNewPassword = value; } }
        public string UpdateOldPassword { get { return updateOldPassword; } set { updateOldPassword = value; } }
        public string UpdateOK { get { return updateOK; } set { updateOK = value; } }
        public string UpdateCancel { get { return updateCancel; } set { updateCancel = value; } }
    }
    #endregion
